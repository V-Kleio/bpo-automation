  ...
  return (
    <>
      <PageHeader
        ...
        description="Multi-channel outreach through the 4-step stakeholder sequence: Champion → Economic Buyer → Technical Gatekeeper → CEO. Open a card to send connection requests, LinkedIn DMs, and email."
        actions={
