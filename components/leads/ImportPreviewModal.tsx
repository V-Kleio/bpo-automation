      ...
      <div className="p-6 space-y-5">
        ...
        {valid.length > 0 && (
          <div className="overflow-hidden rounded-md border border-zinc-200">
            <div className="border-b border-zinc-200 bg-zinc-50 px-3 py-2 text-xs font-semibold uppercase tracking-wider text-zinc-500">
              ...
              <tbody>
                {previewRows.map((r, i) => (
                  <tr key={i} className="border-t border-zinc-100">
                    ...
                    <td className="px-2 py-1.5 text-zinc-500 truncate max-w-[150px]">
                      {r.email ?? "—"}
                    </td>
                    <td className="px-2 py-1.5 text-zinc-700">
                      {r.tier ?? "warm"}
